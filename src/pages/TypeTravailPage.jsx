    ...
    <div className='py-10 px-30 min-h-screen'>
        ...
        <div className='flex gap-4'>
            ...
            <TypeTravailCheckBox title="J'aimerais trouver des opportunités moi-même"
                ...
                option={'1'} selectedOptions={selectedOptions} handleChange={handleChange} image={null}
            />
            ...
            <TypeTravailCheckBox title="J'aimerais emballer mon travail pour que les clients puissent l'acheter"
                ...
                option={'2'} selectedOptions={selectedOptions} handleChange={handleChange} image={null}/>
        </div> 
