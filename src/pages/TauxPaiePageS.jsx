...
export default function TauxPaiePage() {
  return (
    <main className={'text-black min-h-screen bg-white px-5 text-xs sm:text-lg sm:px-10 md:px-30 relative' +
      'flex justify-between align-center gap-y-5'
    } >
      {/* Texte */}
      <div className="flex flex-col justify-center gap-5 w-full sm:max-w-3/4 py-10 ">
        <p>8/10</p>
      ...
      {/* EXAMPLE DE PROFIL*/}
      <div className='w-full flex text-[0.8rem] md:text-lg'>
