...
const LanguePage = () => {
 const [languages, setLanguages] = useState([])
  ...
  return (
    <div className='text-black min-h-screen bg-white px-30 relative' >
      {/* Texte d'intro */}
      <div className="flex flex-col gap-5 max-w-3/4 py-10 ">
        ...
        <div>
        Upwork is globale ,so clients  are often interestend to know what langage you speak. English is a  must,but do you speak  any other  languages .
        </div>
      </div>
