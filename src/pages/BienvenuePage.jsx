...
const BienvenuePage = () => {
  ...
  return (
    <div className='py-10 px-10 sm:px-30 bg-white min-h-screen text-black'>
        ...
        <div className='flex flex-wrap-reverse gap-5 justify-center md:justify-normal items-center'>
            <button onClick={handleStart} className='bg-green-600 text-white px-4 py-2 rounded'>Get started</button> 
             <span className='text-shadow-gray-200'>It only takes 5-10 minutes and you can edit it later. We 'll save as you go</span>
        </div>
    </div>
  )
}
