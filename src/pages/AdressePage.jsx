...
const AdressePage = () => {
  ...
  return (
    < div className='px-10 md:px-30 bg-white text-black text-xs sm:text-[0.9rem] lg:text-lg'>
      <div className='py-6'></div>
      <div className='my-10'>
        <p>10/10</p>
        <h1 className='text-xl sm:text-2xl md:text-4xl w-2/3 my-4 font-semibold'> A few last details, then you can check and publish your profile </h1>
        <h3 className=' w-5/6 my-4 '>
          A professional photo helps you build trust with your client. 
          To keep things safe and simple, they'll pay you through us - 
          which is why we need your personal information. 
        </h3>
      </div>

      <div className=' flex flex-wrap justify-center row mt-5 h-full gap-y-10 '>
        <div className="w-[25%] flex flex-col justify-center items-center md:items-start md:justify-start gap-4  rounded-md">
